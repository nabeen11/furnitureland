<?php
/**
 * Furniture Land Theme Customizer
 *
...
function furniture_customize_preview_js() {
	wp_enqueue_script( 'furniture-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}

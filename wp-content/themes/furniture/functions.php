<?php
/**
 * Furniture Land functions and definitions
 *
...
function furniture_setup() {
	/*
		...
		* If you're building a theme based on Furniture Land, use a find and replace
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'furniture_custom_background_args',
			array(
...
function furniture_scripts() {
	wp_enqueue_style( 'furniture-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'furniture-style', 'rtl', 'replace' );

	wp_enqueue_script( 'furniture-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
 ...
 * Home Banner.
 */
require get_template_directory() . '/inc/Banner/home-banner.php';
